package com.aires.kafka.monitor.infra;

import com.aires.kafka.monitor.domain.constant.KafkaMonitorConstant;
import com.aires.kafka.monitor.domain.model.KafkaMonitorInfo;
import com.aires.kafka.monitor.domain.server.KafkaMonitorRepo;
...
/**
 * Created by aires on 2016/12/08.
 */
@Repository
